            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kelas.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="school_fee_id">Nama SPP</label>
                            <select name="school_fee_id" id="school_fee_id" class="form-select" required>
                                <option value="">Pilih SPP</option>
                                @foreach ($school_fees as $school_fee)
                                <option value="{{ $school_fee->id }}">{{ $school_fee->name }}</option>
                                @endforeach
                            </select>
                        </div>
